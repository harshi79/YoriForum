...
Classic category sections · emoji reactions · upvotes + automatic **member ranks** (Newbie → Legend) · dark mode · file uploads · polls · ✅ solved markers · GitHub/Google login · spam shields (approval queue + StopForumSpam checks) · sitemap/SEO · mod tools (sticky/lock/split/merge/suspend) · member directory · rules/FAQ pages · 🔒 like-to-unlock hidden content · ⚡ YoriCoins · 🎖 badges · 📥 requests · 🏆 contests · 📲 PWA install.
